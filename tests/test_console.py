...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unittest for testing prompting of HBNB command interpreter."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Unittests for testing help messages of HBNB command interpreter."""

    def test_help_quit(self):
        h = "Quit command to exit program."
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_show(self):
        h = ("Usage: show <class> <id> or <class>.show(<id>)\n"
             "Display string representation of a class instance of"
             " a given id.")
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unittests for testing exiting from HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Unittests for testing create from HBNB command interpreter."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Unittests for testing show from HBNB command interpreter"""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests for testing destroy from HBNB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """Unittests for testing all of HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unittests for testing update from HBNB command interpreter."""
